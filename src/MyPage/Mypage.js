...
const navigate = useNavigate()
            return (<div className={"Mypage_container"}>
           ...
           <img src={mypage_login_btn} width={30} height={30} className={"Mypage_logout_icon"}/>
            ...
            onClick={() => {if(!alert("로그아웃 되었습니다.")){
            sessionStorage.removeItem("login_information");navigate(0)}}}>로그아웃</span></div>)
            :(<><div className={"Mypage_logout_btn Mypage_login_btn"}>
            <img src={mypage_login_btn} width={30} height={30} className={"Mypage_logout_icon"}/>
            <span className={"Mypage_logout_text"} onClick={()=>navigate('/Login')}>로그인
            </span></div>
            <div className={"Mypage_logout_btn Mypage_login_btn"}>
            <img src={mypage_login_btn} width={30} height={30} className={"Mypage_logout_icon"}/>
            <span className={"Mypage_logout_text"} onClick={()=>navigate('/Sign_up')}>회원가입
            </span></div></>)}</div>
            ...
            <h1 className={"Mypage_subtitle"}>정보</h1><div className={"Mypage_body_row"}>
            ...
            <img src={mypage_service} width={18} height={20}/><h1 className={"Mypage_body_row_text"}>서비스 이용약관</h1></div>
            <div className={"Mypage_body_row"}>
            <img src={mypage_version} width={24} height={24}/><h1 className={"Mypage_body_row_text"}>버전 정보</h1></div></div>
            ...
            <img src={mypage_mycloth} width={24} height={24}/><h1 className={"Mypage_body_row_text"}
            ...
            <div className={"Mypage_body_row"}>
            <img src={mypage_myinfo} width={24} height={24}/><h1 className={"Mypage_body_row_text"}
            onClick={() =>!!sessionStorage.getItem("login_information")? 
            navigate(`/My_page/StyleChange`): alert("로그인후 이용이 가능한 서비스 입니다.")}>내정보 수정하기</h1>
            <img src={mypage_goto_btn} width={8.33} height={10} className={"Mypage_body_row_gotobtn"}/></div>
            <div className={"Mypage_body_row"}>
            <img src={mypage_password} width={24} height={24}/> <h1 className={"Mypage_body_row_text"}
