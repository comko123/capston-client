...
const Border = () => {
    const [navigate, searchRef, { pathname }] = [useNavigate(), useRef(), useLocation()]
            ...
            <><div className="topContanier">
                ...
                <div style={!currentData?.length ? { height: "30vh" } : { height: `165vh` }}>
                    ...
                    <form className="numFormBtn" onSubmit={e => e.preventDefault()}>
                        ...
                        <BorderButtonList currentData={currentData} borderStyleObject={borderStyleObject}
                            borderClickStyleObject={borderClickStyleObject} />
                    ...
                    <div className="writingBtnPR">
                        <Link className="writingBtn" to={"/detail/write"}>
                            <div className="pen_square">
                                <img src={pen_square} width="20" height="20" /></div>글쓰기</Link></div>
                </div></div><MenuBar /></>}</>)
}
