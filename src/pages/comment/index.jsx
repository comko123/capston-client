        ...
        <><ul>{
                ...
                return (
                    <div className="commentList" key={index}>
                        <li><hr className="comment_HR" />
                            ...
                            <div className="commentContentsPR"></div></li></div>)
            })}</ul>
            ...
            <form onSubmit={async e => {
                ...
                try {
                    ...
                    parsingLogic(setMessage, newCommentInfo)
                } catch (error) { console.log(error) }
            }}>
                <div className="commentSubmitPR">
                    <input className="nickname" type="text" placeholder="닉네임을 입력하세요." ref={creNickName} />
