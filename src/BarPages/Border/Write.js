...
<img src={pageback_btn} width={16} height={16} alt=""className={"Myadress_pageback"} onClick={()=>navigate(-1)}/></div>
<h2 className="writingName">글쓰기</h2><div className="writingSubmitPR">
...
<input className="writingTitle"type="text" placeholder="제목을 입력해주세요." ref={titArticle} minLength="1"/><br/><br/>
<textarea className="writingFillOut" placeholder="내용을 입력해주세요." ref={conArticle} rows="15" cols="60"/></>)}
