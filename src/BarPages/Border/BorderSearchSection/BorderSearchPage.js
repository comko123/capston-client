...
<BorderSearchButtonList langth={data.totalElements} searchParams={userText} styleBorderObject={styleBorderObject} styleBoxObject={styleBoxObject}/>
<input className="nextBtn" type="button" value=">"disabled={!data.content.length?nextContentEmpty?true:false:nextContentNotEmpty?true:false} 
